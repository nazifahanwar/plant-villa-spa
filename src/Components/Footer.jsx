...
const Footer = () => {
  ...
  <aside>
    ...
    <p className='text-xl playwrite-au-tas text-white pt-2'>
      ...
      <p className='text-white'>A calm corner of nature,online.
</p>
...
<div className='border-t-gray-600 border-t-1 container mx-auto p-4 flex justify-between'>
  <p className='text-white text-center'>© 2025 Plant Villa. All rights reserved.</p>
